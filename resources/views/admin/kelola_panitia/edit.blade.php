...
@section('content')
                ...
                <form action="/admin/panitia/update/{{$panitia->id}}" method="POST">
                    @csrf
                    @method('POST')
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="username" placeholder="Username" type="text" value="{{$panitia->username}}"></input>
                            </div>
                        </div>
                        <div class="col-xs-5 col-sm-5 col-md-5">
                            ...
                            name="acara_id"                                                    
                            placeholder=""/>
                            <option value="{{$panitia->acara_id}}" selected>Pilih Acara</option>
